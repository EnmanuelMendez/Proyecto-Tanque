...
public class TankManager
{
    ...
    public Transform m_SpawnPoint;                      // Posición y dirección en la que se generará el tanque
    ...
    public void Setup()
    {
        ...
        // Ajusto los números de jugadores para que sean iguales en todos los scripts
    ...
    // Usado durante las fases del juego en las que el jugador debe poder controlar el tanque
